...
public class LoadingPopAd {
    ...
    /**  * 获取开屏布局  * @param context  * @param time  * @return  */
    ...
    private LinearLayout getLoadingLayout(final Context context, final int time){
        ...
        l_layout.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FILL_PARENT, LinearLayout.LayoutParams.FILL_PARENT, 1f));
        // 加载图片的布局
...
//        }
        ...
        textView.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FILL_PARENT, LinearLayout.LayoutParams.FILL_PARENT, 5f));
