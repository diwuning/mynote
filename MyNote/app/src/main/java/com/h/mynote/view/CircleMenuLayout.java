...
public class CircleMenuLayout extends ViewGroup
{
     ...
     * 该容器内child item的默认尺寸
     */
    private static final float RADIO_DEFAULT_CHILD_DIMENSION = 1 / 4.5f;
    /**
     * 菜单的中心child的默认尺寸
     */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        // 获得半径
        mRadius = Math.max(getMeasuredWidth()+50, getMeasuredHeight()+50);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b)
    {
		...
		/*final TextView tv = (TextView) cView.findViewById(R.id.id_circle_menu_item_text);*/
        if (cView != null)
        {
